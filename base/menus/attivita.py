    ...
    if me and me.volontario:
        ...
        return (
            ...
            ("Gestione", (
                ...
                ("Organizza servizio", "fa-asterisk", "/servizi/organizza/") if attivita_area_exists else None,
                ("Elenco servizio", "fa-list", "/servizi/gestisci/") if me.oggetti_permesso(GESTIONE_ATTIVITA).exists() else None,
