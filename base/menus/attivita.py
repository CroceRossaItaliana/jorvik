    ...
    if me and me.volontario:
        ...
        return (
            ...
            ("Gestione", (
                ...
                ("Crea servizio", "fa-asterisk", "/attivita/servizio/organizza/") if progetti_exists else None,
                ("Elenco servizi", "fa-list", "/attivita/servizio/gestisci/") if progetti_exists else None,
