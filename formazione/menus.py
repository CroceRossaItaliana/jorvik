...
def formazione_menu(menu_name, me=None):
    ...
    FORMAZIONE = (
        ("Corsi", (
            ...
            ('Schema equipollenze Del. N° 66-20', 'fa-book', 'https://datafiles.gaia.cri.it/media/filer_public/71/25/71253ac6-f878-46c7-88b9-68d93daa2e53/schema_per_equipollenze_del_66-20_per_gaia.pdf'),
            ('Schema equipollenze Del. N° 94-20', 'fa-book', 'https://datafiles.gaia.cri.it/media/filer_public/a6/1b/a61b14e5-7286-4028-8aeb-255e0a4a7209/schema_per_equipollenze_94-20_per_gaia.pdf'),
