...
def formazione_menu(menu_name, me=None):
    ...
    FORMAZIONE = (
        ("Corsi", (
            ...
            ('Schema equipollenze Del. N° 66-20', 'fa-file-alt', 'https://https://datafiles.gaia.cri.it/media/filer_public/22/c4/22c446a7-d981-4cb9-be95-f6afec4b53d2/schema_per_equipollenze_del_66-20_per_gaia_1.pdf'),
