...
urlpatterns = [
    ...
    url(r'^corsi-base/elenco/$', formazione_corsi_base_elenco, name='list_courses'),
    url(r'^corsi-base/(?P<pk>[0-9]+)/direttori/$', formazione_corsi_base_direttori, name='director'),
    url(r'^corsi-base/(?P<pk>[0-9]+)/fine/$', formazione_corsi_base_fine, name='end'),
