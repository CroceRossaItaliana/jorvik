    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mittente', models.ForeignKey(null=True, blank=True, to='anagrafica.Persona', default=None)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='destinatario',
            name='persona',
            field=models.ForeignKey(null=True, blank=True, to='anagrafica.Persona', default=None),
        ),
    ]
