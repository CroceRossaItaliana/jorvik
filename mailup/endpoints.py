...
ENDPOINTS = {
    ...
    'subscribe': '{}/API/{}/Rest{}'.format(MAIN_URL, VERSION, '/ConsoleService.svc/Console/List/{}/Recipient?ConfirmEmail=true'),
    'get_list': '{}/API/{}/Rest{}'.format(MAIN_URL, VERSION, '/ConsoleService.svc/Console/List/{}'),
