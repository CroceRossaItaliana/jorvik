# -*- coding: utf-8 -*-
# Generated by Django 1.9.12 on 2017-02-19 09:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='motivo',
            field=models.CharField(choices=[('VOL', 'Dimissioni Volontarie'), ('TUR', 'Mancato svolgimento turno'), ('RIS', 'Mancato rientro da riserva'), ('QUO', 'Mancato versamento quota annuale'), ('RAD', 'Radiazione da Croce Rossa Italiana'), ('DEC', 'Decesso'), ('TRA', 'Trasformazione in volontario'), ('ALT', 'Altro')], max_length=3),
        ),
    ]
