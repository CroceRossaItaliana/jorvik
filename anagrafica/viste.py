...
from .permessi.applicazioni import (PRESIDENTE, UFFICIO_SOCI,
                                    PERMESSI_NOMI_DICT,
                                    DELEGATO_OBIETTIVO_1, COMMISSARIO,
                                    ...
                                    UFFICIO_SOCI_UNITA, DELEGHE_RUBRICA,
                                    REFERENTE,
                                    RESPONSABILE_AREA, DIRETTORE_CORSO,
                                    DELEGATO_AREA, REFERENTE_GRUPPO,
    ...
    sezioni.update({
        "Delegati": [
            ...
            (DELEGATO_OBIETTIVO_2, "Inclusione Sociale", sede.delegati_attuali(tipo=DELEGATO_OBIETTIVO_2).count(),
             []),
            (DELEGATO_OBIETTIVO_3, "Operazione, Emergenza e Soccorsi", sede.delegati_attuali(tipo=DELEGATO_OBIETTIVO_3).count(),
             []),
