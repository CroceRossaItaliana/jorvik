...
from anagrafica.permessi.costanti import GESTIONE_OPERAZIONI
...
def sala_operativa(me):
    ...
    if me and me.volontario:
        ...
        return (
            ...
            #      reverse('so:gestisce_operazione')) if gestione_so or gestione_funzioni else None,
