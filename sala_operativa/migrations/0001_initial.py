...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('anagrafica', '0065_auto_20201112_1555'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('settore', models.CharField(blank=True, choices=[('COORDINAMENTO', 'Coordinamento'), ('OPERAZIONE_SOCCORSO_E_SANITA', 'Operazione soccorso e sanitarie'), ('OPERAZIONI_SOCIO_ASSISTENZIALI', 'Operazioni socio assistenziali'), ('PIANIFICAZIONE', 'Pianificazione'), ('LOGISTICA', 'Logistica'), ('AMMINISTRAZIONE_E_SEGRATERIA', 'Amministrazione e segreteria')], db_index=True, default='COORDINAMENTO', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mezzo_tipo', models.CharField(blank=True, choices=[('m1', 'Mezzo CRI'), ('m3', 'Mezzo privato'), ('m2', 'Mezzo in leasing')], max_length=3, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attivatore', models.CharField(blank=True, choices=[('DIPARTIMENTO_PROTEZIONE_CIVILE', 'Dipartimento protezione civile'), ('REGIONE', 'Regione'), ('PREFETTURA', 'Prefettura'), ('PROVINCIA', 'Provincia'), ('COMUNE', 'Comune'), ('CRI', 'CRI'), ('IFRC', 'IFRC'), ('ALTRO', 'Altro')], db_index=True, default='DIPARTIMENTO_PROTEZIONE_CIVILE', max_length=50, null=True)),
                ('inizio', models.DateTimeField(db_index=True, default=django.utils.timezone.now)),
                ('fine', models.DateTimeField(blank=True, db_index=True, null=True)),
                ('archivia_emergenza', models.BooleanField(default=False)),
                ('operazione', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='sala_operativa.OperazioneSO')),
        ...
        migrations.AlterIndexTogether(
            name='partecipazioneso',
            index_together=set([('turno', 'stato'), ('reperibilita', 'turno', 'stato'), ('reperibilita', 'turno')]),
        ),
    ]
